...
angular.module('atsPadApp')
  .factory 'appEditorService', (appNotificationService) ->
    ...
    
    {
    	init: (idSelector) ->
    		...
    		session.setShowPrintMargin(options.showPrintMargin)
    		session.setOption("vScrollBarAlwaysVisible", options.vScrollBarAlwaysVisible)
